  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn(
          "absolute inset-0 z-[2] flex h-10 w-full cursor-pointer appearance-none items-center justify-between gap-2 rounded border border-neutral-default bg-neutral-default px-3 py-2 text-center text-base text-neutral-default focus-ring-neutral data-[placeholder]:text-neutral-muted hover:bg-component-neutral-hover disabled:cursor-not-allowed disabled:bg-component-neutral-default disabled:opacity-75"
        ),
        nav: cn("flex items-center gap-2"),
        nav_button: cn(
          "pointer-events-auto flex h-10 items-center justify-center gap-2 rounded border border-neutral-default bg-transparent p-3 text-base font-medium text-neutral-muted outline-none transition-all focus-ring-neutral active:bg-component-neutral-pressed hover:bg-component-neutral-hover disabled:cursor-not-allowed disabled:opacity-75"
        ),
        ...
        day: cn(
          "h-10 w-10 rounded transition-colors active:bg-component-neutral-pressed active:text-neutral-default hover:bg-component-neutral-hover focus-visible:outline-none focus-visible:ring focus-visible:ring-neutral"
        ),
        day_selected: cn(
        ...
        day_disabled: cn("opacity-25 active:bg-white active:text-gray-800 hover:bg-white"),
