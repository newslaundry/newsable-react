...
export const Default: Story = {
  render: () => (
    <Tabs variant="default" defaultValue="account" orientation="horizontal" className="mx-auto max-w-3xl">
      <Tabs.List>
...
export const Underlined: Story = {
  render: () => (
    <Tabs variant="underlined" defaultValue="account" orientation="horizontal" className="mx-auto max-w-3xl">
      <Tabs.List>
        <Tabs.Trigger value="account">Account</Tabs.Trigger>
        <Tabs.Trigger value="subscription">Subscription</Tabs.Trigger>
        <Tabs.Trigger value="saved">Saved Stories</Tabs.Trigger>
...
export const Pill: Story = {
  render: () => (
    <Tabs variant="pill" defaultValue="account" orientation="horizontal" className="mx-auto max-w-3xl">
      <Tabs.List>
        <Tabs.Trigger value="account">Account</Tabs.Trigger>
        <Tabs.Trigger value="subscription">Subscription</Tabs.Trigger>
        <Tabs.Trigger value="saved">Saved Stories</Tabs.Trigger>
...
export const VerticalDefault: Story = {
  render: () => (
    <Tabs variant="default" defaultValue="profile" className="mx-auto max-w-3xl" orientation="vertical">
      <Tabs.List>
        <Tabs.Group>
        ...
        <div role="presentation" className="h-[1px] w-full bg-separator-neutral"></div>
        <Tabs.Group>
...
export const VerticalPill: Story = {
  render: () => (
    <Tabs variant="pill" defaultValue="profile" className="mx-auto max-w-3xl" orientation="vertical">
      <Tabs.List>
        <Tabs.Group>
          <Tabs.GroupLabel>My account</Tabs.GroupLabel>
          <Tabs.Trigger value="subscription">
...
export const VerticalUnderlined: Story = {
  render: () => (
    <Tabs variant="underlined" defaultValue="profile" className="mx-auto max-w-3xl" orientation="vertical">
      <Tabs.List>
        <Tabs.Group>
          <Tabs.GroupLabel>My account</Tabs.GroupLabel>
          <Tabs.Trigger value="subscription">
